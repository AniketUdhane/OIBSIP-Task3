...
class Account
{
	...
	void login()
	{
		...
		if(flag==3)
		{
			System.out.println("No. of trials exhausted!!!");
			System.exit(0);
		}
	}
	public void menu()
		...
		do
		{
			...
			switch(ch)
			{
				...
				case 3:		//deposit
					...
					break;
				case 4:		//transfer
					Account b1 = new Account("Abhishek","7121");
	...
	void transfer(double amt,Account b1)
	{
		...
		System.out.println(b1.name+"'s balance is Rs."+b1.bal1);
	}
}
...
class AtmInterface
{
	...
	{
		Account b = new Account("Aniket","8421");
		b.login();
	}
}
